...
export const VARIANT_FEEDS: Record<string, Record<string, ServerFeed[]>> = {
  ...
  magen: {
    middleeast: [
      ...
      { name: 'Channel 14', url: gn('site:now14.co.il when:2d') },
      ...
      { name: 'N12/Mako', url: 'https://rcs.mako.co.il/rss/31750a2610f26110VgnVCM1000005201000aRCRD.xml', lang: 'he' },
      { name: 'Maariv', url: 'https://www.maariv.co.il/Rss/RssChadashot', lang: 'he' },
      { name: 'Globes Hebrew', url: 'https://www.globes.co.il/webservice/rss/rssfeeder.asmx/FeederNode?iID=585', lang: 'he' },
      { name: 'BBC Middle East', url: 'https://feeds.bbci.co.uk/news/world/middle_east/rss.xml' },
      { name: 'Al Jazeera', url: 'https://www.aljazeera.com/xml/rss/all.xml' },
