...
const MAGEN_FEEDS: Record<string, Feed[]> = {
  ...
  middleeast: [
    ...
    // Direct Hebrew RSS feeds (high volume, reliable, no Google proxy)
    { name: 'Ynet Hebrew', url: rss('https://www.ynet.co.il/Integration/StoryRss2.xml'), lang: 'he' },
    { name: 'Walla Hebrew', url: rss('https://rss.walla.co.il/feed/1'), lang: 'he' },
    { name: 'Israel Hayom Hebrew', url: rss('https://www.israelhayom.co.il/rss.xml'), lang: 'he' },
    { name: 'N12/Mako', url: rss('https://rcs.mako.co.il/rss/31750a2610f26110VgnVCM1000005201000aRCRD.xml'), lang: 'he' },
    { name: 'Maariv', url: rss('https://www.maariv.co.il/Rss/RssChadashot'), lang: 'he' },
    { name: 'Globes Hebrew', url: rss('https://www.globes.co.il/webservice/rss/rssfeeder.asmx/FeederNode?iID=585'), lang: 'he' },
    { name: 'BBC Middle East', url: rss('https://feeds.bbci.co.uk/news/world/middle_east/rss.xml') },
...
export const DEFAULT_ENABLED_SOURCES: Record<string, string[]> = {
  ...
  magen_middleeast: ['Times of Israel', 'Jerusalem Post', 'Haaretz', 'Ynet News', 'i24NEWS', 'Israel Hayom', 'Channel 14', 'Ynet Hebrew', 'Walla Hebrew', 'N12/Mako', 'Maariv', 'BBC Middle East', 'Iran International'],
